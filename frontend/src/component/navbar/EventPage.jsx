    ...
    return events
      .filter(event => {
        ...
        return matchesSearch && matchesCategory && matchesType && 
               matchesFormat && matchesDateFrom && matchesDateTo;
      })
      .sort((a, b) => {
  ...
  const handleAddOrUpdateEvent = (e) => {
    ...
    if (editingEvent) {
      ...
      const newEventWithId = {
        ...
        userId: currentUser.id, // Associate event with current user
    ...
    <div className="container">
      ...
      <div className="filters-section">
        ...
        <div className="sort-controls">
          ...
          >
            Sort by Date {filters.sortBy === 'date' && (filters.sortOrder === 'asc' ? '↑' : '↓')}
          </button>
          <button
            className={`sort-button ${filters.sortBy === 'title' ? 'active' : ''}`}
            onClick={() => handleSortChange("title")}
          >
            Sort by Title {filters.sortBy === 'title' && (filters.sortOrder === 'asc' ? '↑' : '↓')}
          </button>
        </div>
      </div>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <form onSubmit={handleAddOrUpdateEvent}>
              ...
              <div className="form-group">
                <label>Format</label>
                <select name="format" value={newEvent.format} onChange={handleInputChange}>
                  <option value="Offline">Offline</option>
                  <option value="Online">Online</option>
                </select>
              </div>
      ...
      <div className="events-grid">
        {(view === 'all' ? upcomingEvents : filteredEvents).map((event) => (
